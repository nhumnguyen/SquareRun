...
OFILES = main.o gameboy.o gameover.o  myLib.o lives.o font.o  startscreen.o winscreen.o  inky.o  me.o ball.o wall.o

# The header files you have created.
# This is necessary to determine when to recompile for files.
# This should be a space (SPACE!) separated list of .h files
HFILES = gameboy.h myLib.h font.h gameover.h lives.h startscreen.h winscreen.h inky.h  me.h ball.h wall.h
